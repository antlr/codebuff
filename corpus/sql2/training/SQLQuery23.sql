...
GROUP BY SourceServer, SourceDB, DestServer, DestDB, TaskName, PackageName,
    ErrorDateTime, ErrorMessage
...
GROUP BY dmcl.ClientID, dmcl.SourceServer, dmcl.SourceDB, dmcl.DestServer,
    dmcl.DestDB, dmcl.TaskName, dmcl.PackageName, dmcl.ErrorDateTime,
    dmcl2.ErrorDateTime, dmcl.ErrorMessage, dmcl2.ErrorMessage, dmcl2.ClientID,
    dmcl2.TaskName
