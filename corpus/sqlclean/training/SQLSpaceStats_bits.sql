...
FROM SQLSpaceStats a
    ...
    (
        ...
        FROM SQLSpaceStats
        GROUP BY Server_Name, dbname, flag, FileID, FileGroup, total_space,
            usedspace, freespace, freepct, Name, LastUpdate, [FileName]
        HAVING count(*) > 1) b
...
GROUP BY LastUpdate, dbname, server_name, ServerID, flag, Fileid, FileGroup,
    total_space, freespace, freepct, [FileName]
