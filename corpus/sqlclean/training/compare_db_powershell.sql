...
SELECT
    @cmd2 = 'E:\Dexma\powershell_bits\Compare-DMartSchema2.ps1 -SqlServerOne ' +
            @SERVERNAME + ' -FirstDatabase DMart_Template_Data -SqlServerTwo ' +
            @SERVERNAME + ' -DatabaseList ' + @dblistData + ' -Column -Log'

SELECT
    @cmd3 = 'E:\Dexma\powershell_bits\Compare-DMartSchema2.ps1 -SqlServerOne ' +
...
SELECT @CDCcmd =
       'E:\Dexma\powershell_bits\Compare-DMartSchema2.ps1 -SqlServerOne ' +
