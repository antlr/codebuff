...
GROUP BY DeviceID, MonitorID, ita.monitor_category, Name, [Address], imm.TypeID,
    [Description]
------------------------------------------------------------------------------------------------------------------------
...
FROM IPMonMonitors imm
    INNER JOIN IPMonTypeAssoc ita ON imm.TypeID = ita.typeid
    INNER JOIN IPMonGroupMembers igm ON imm.MonitorID = igm.MonitorID
GROUP BY DeviceID, imm.MonitorID, imm.TypeID, ita.monitor_category, Name,
    [Address], [Description]
------------------------------------------------------------------------------------------------------------------------
