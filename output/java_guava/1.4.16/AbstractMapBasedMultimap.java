...
abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V>
  ...
  private class WrappedSortedSet extends WrappedCollection implements SortedSet<V> {
    ...
    public SortedSet<V> headSet(V toElement) {
      ...
      return new WrappedSortedSet(
        getKey(),
        getSortedSetDelegate().headSet(toElement), (getAncestor() == null) ? this : getAncestor());
    }
    ...
    public SortedSet<V> subSet(V fromElement, V toElement) {
      ...
      return new WrappedSortedSet(
        getKey(),
        getSortedSetDelegate().subSet(fromElement, toElement), (getAncestor() == null) ? this : getAncestor());
    }
    ...
    public SortedSet<V> tailSet(V fromElement) {
      ...
      return new WrappedSortedSet(
        getKey(),
        getSortedSetDelegate().tailSet(fromElement), (getAncestor() == null) ? this : getAncestor());
    }
  }
  ...
  private class WrappedList extends WrappedCollection implements List<V> {
    ...
    public List<V> subList(int fromIndex, int toIndex) {
      ...
      return wrapList(
                                                                           getKey(),
                                                                           getListDelegate().subList(fromIndex, toIndex), (getAncestor() == null) ? this : getAncestor());
    }
