...
final class GraphErrorMessageUtils {
  ...
  static final String NOT_AVAILABLE_ON_UNDIRECTED = "Cannot call source()/target() on an undirected graph. " + "Consider using incidentNodes() (if you don't know either incident node) " + "or Graphs.oppositeNode() (if you know one of the incident nodes).";
}