...
final class RegularImmutableSortedSet<E> extends ImmutableSortedSet<E> {
  static final RegularImmutableSortedSet<Comparable> NATURAL_EMPTY_SET = new RegularImmutableSortedSet<Comparable>(ImmutableList.<Comparable>of(), Ordering.natural());
  ...
  int headIndex(E toElement, boolean inclusive) {
    return SortedLists.binarySearch(
      ...
      comparator(), inclusive ? FIRST_AFTER : FIRST_PRESENT,
      NEXT_HIGHER);
  }
  ...
  int tailIndex(E fromElement, boolean inclusive) {
    return SortedLists.binarySearch(
      ...
      comparator(), inclusive ? FIRST_PRESENT : FIRST_AFTER,
      NEXT_HIGHER);
  }
  ...
  int indexOf(@Nullable Object target) {
    ...
    try {
      position =
  SortedLists.binarySearch(elements, target, unsafeComparator(), ANY_PRESENT, INVERTED_INSERTION_INDEX);
    } catch (ClassCastException e) {
      return -1;
    }
