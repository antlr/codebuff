...
+ ". To index multiple values under a key, use Multimaps.index.");
  ...
  static class UnmodifiableNavigableMap<K, V> extends ForwardingSortedMap<K, V>
    ...
    public NavigableMap<K, V> descendingMap() {
      ...
      return (result == null) ? descendingMap = new UnmodifiableNavigableMap<K, V>(delegate.descendingMap(), this) : result;
    }
  ...
  static class SortedKeySet<K, V> extends KeySet<K, V>
  ...
  @GwtIncompatible // NavigableMap
  static class NavigableKeySet<K, V> extends SortedKeySet<K, V>
