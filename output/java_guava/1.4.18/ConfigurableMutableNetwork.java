...
final class ConfigurableMutableNetwork<N, E> extends AbstractConfigurableNetwork<N, E>
  ...
  private NodeConnections<N, E> newNodeConnections() {
            ...
            : allowsParallelEdges() ? UndirectedMultiNodeConnections.<N, E>of() : UndirectedNodeConnections.<N, E>of();
  }
}