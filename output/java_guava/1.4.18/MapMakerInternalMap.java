...
class MapMakerInternalMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
  ...
  @WeakOuter final class KeySet extends SafeToArraySet<K> {
    @Override
  ...
  @WeakOuter final class Values extends AbstractCollection<V> {
    @Override
  ...
  @WeakOuter final class EntrySet extends SafeToArraySet<Entry<K, V>> {
    @Override
  ...
  Object writeReplace() {
    return new SerializationProxy<K, V>(keyStrength, valueStrength, keyEquivalence, valueEquivalence, concurrencyLevel, this);
  }
