...
public final class ServiceManager {
    ...
    for (Service service : services) {
      try {
        ...
        logger.log(Level.WARNING,
                   "Unable to start Service " + service, e);
      }
    }
    return this;
  }
  ...
  public String toString() {
    return MoreObjects.toStringHelper(ServiceManager.class).add("services", Collections2.filter(services, not(instanceOf(NoOpService.class)))).toString();
  }
  ...
  private static final class ServiceManagerState {
    ...
    @GuardedBy("monitor") boolean ready;

    @GuardedBy("monitor") boolean transitioned;
    ...
    @WeakOuter final class AwaitHealthGuard extends Monitor.Guard {
      AwaitHealthGuard() {
    ...
    @WeakOuter final class StoppedGuard extends Monitor.Guard {
      StoppedGuard() {
        super(ServiceManagerState.this.monitor);
      }
