...
final class UndirectedMultiNodeConnections<N, E> extends AbstractUndirectedNodeConnections<N, E> {
  ...
  static <N, E> UndirectedMultiNodeConnections<N, E> of() {
    return new UndirectedMultiNodeConnections<N, E>(Maps.<E, N>newHashMapWithExpectedSize(EXPECTED_DEGREE));
  }
  ...
  public Set<E> edgesConnecting(final Object node) {
    return Collections.unmodifiableSet(Maps.filterEntries(incidentEdgeMap, new Predicate<Entry<E, N>>() {
                                                                             @Override
