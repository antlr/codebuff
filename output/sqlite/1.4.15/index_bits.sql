...
FROM SQLIndexRebuilds a
    ...
    (
        ...
        HAVING count(*) > 1) b
        ON a.ServerName = b.ServerName AND a.DBName = b.DBName
           AND
           a.SQLStatement = b.SQLStatement
           AND
           a.IndexType = b.IndexType
           AND
           a.FragPercent = b.FragPercent AND a.seq_num < b.max_seq_num
...
SELECT
    'dbcc showcontig (' + CONVERT(varchar(20), i.id) +
    ',' + -- table id
