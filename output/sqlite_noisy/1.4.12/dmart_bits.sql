...
UPDATE ClientConnection SET Status = '0' WHERE Beta = '1'
...
UPDATE ClientConnection SET SourceServer = 'PSQLDLS30'
WHERE SourceDB = 'HiwayCU'

UPDATE ClientConnection SET Client_ID = '228' WHERE SourceDB = 'RLC'
