...
GROUP BY Beta
              , Status
              , SSISInstanceID, SourceDB, LoadStageDBStartDate, LoadStageDBEndDate, LoadReportDBStartDate, LoadReportDBEndDate
ORDER BY Status ASC
    , SSISInstanceID ASC
      , Beta ASC
...
--WHERE beta = 1 WHERE SourceDB = 'PADemoDU'
-------------------------------------------
/*
...
AND TaskName = 'Data Flow Task br_liability'
         ...
         GROUP BY TaskName, ErrorDateTime
               , PackageName, DestDB, DestServer, SourceDB, SourceServer, ID, ClientId, ErrorMessage
ORDER BY ErrorDateTime ASC
----------------------------------------------
...
UPDATE ClientConnection
SET SSISInstanceID = 3 WHERE SourceDB = 'GTE32'
