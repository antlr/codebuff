...
SELECT DeviceID, imm.MonitorID, igm.GroupID, [Address], imm.Name, ita.monitor_category, imm.TypeID, [Description]
FROM    IPMonMonitors imm
INNER JOIN IPMonTypeAssoc ita
ON imm.TypeID = ita.typeid
INNER JOIN IPMonGroupMembers igm
...
GROUP BY DeviceID, imm.MonitorID, igm.GroupID, ita.monitor_category, [Address], [Description], imm.TypeID, imm.Name;
------------------------------------------------------------------------------------------------------------------------
-- PIVOT on GroupNames
