...
CREATE
TABLE [dbo].[Items]([ItemId] [int] NOT NULL, [Item] [varchar](100)NOT NULL)CREATE
                                                                           TABLE [dbo].[PriceHistory]([ItemId] [int] NOT NULL, [PriceStartDate] [datetime] NOT NULL, [Price] [decimal](10,2)NOT NULL)
...
FROM PriceCompare currow
    LEFT JOIN PriceCompare nextrow ON currow.rownum = nextrow.rownum - 1
                                      AND currow.ItemId = nextrow.ItemId
    LEFT JOIN PriceCompare prevrow ON currow.rownum = prevrow.rownum + 1
