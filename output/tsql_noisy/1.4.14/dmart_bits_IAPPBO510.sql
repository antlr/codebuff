...
UPDATE ClientConnection_test SET Status = 0


UPDATE ClientConnection_test SET Beta = '0'
--WHERE Beta = '1'
...
FROM ClientConnection_test
ORDER BY Beta, SourceDB
UPDATE ClientConnection SET Beta = '1'
...
UPDATE ClientConnection SET ReportServer = 'PSQLRPT22'
...
UPDATE ClientConnection_test SET Beta = 1
WHERE CDCReportDB = 'Dmart_GTE32_Data'

UPDATE ClientConnection_test SET CDCReportDB = 'Dmart_GTECDC_Data'
WHERE CDCReportDB = 'Dmart_GTE32CDC_Data'

UPDATE ClientConnection SET SSISInstanceID = 3
