...
SELECT SUM(DataLoadTime) AS TotalStageLoadTime
      --, SUM(ReportLoadTime) AS TotalReportLoadTime FROM (
                                                                                                         SELECT ClientID, [dbo].[ClientConnectionCDC].[CDCExtractDB]
                                                                                                                        ,[Status],
                                                                                                                Beta, [dbo].[ClientConnectionCDC].[StartTimeExtract]
...
SET SSISinstanceID = CASE SourceServer WHEN 'PSQLDLS30' THEN 0 WHEN 'PSQLDLS31' THEN 1
                                       WHEN 'PSQLDLS32' THEN 2
                                       WHEN 'PSQLDLS33' THEN 3 WHEN 'PSQLDLS34' THEN 4
                                       WHEN 'PSQLDLS35' THEN 5
                                       WHEN 'PSQLRPT24' THEN 5 -- DMart Template END
